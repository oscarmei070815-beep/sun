...
export const INFO_COPY = Object.freeze({
  ...
  titania: createEntry('卫星', 'Titania', '天王星的主要卫星之一，在聚焦模式下位于倾斜环系附近。', ['天王星卫星', '主要卫星']),
  oberon: createEntry('卫星', 'Oberon', '较远的天王星卫星，轨道平缓，色调更沉静。', ['天王星卫星', '外侧卫星']),
  neptune: createEntry('行星', '海王星', '深蓝色冰巨星，带有细微条纹和遥远寒冷的观感。', ['冰巨星', '深蓝']),
  triton: createEntry('卫星', 'Triton', '围绕海王星运行的明亮冰冷卫星。', ['海王星卫星', '冰质']),
  pluto: createEntry('矮行星', '冥王星', '太阳系边缘的小型天体，体积虽小但可聚焦观察。', ['矮行星', '外太阳系']),
  charon: createEntry('卫星', 'Charon', '冥王星的伴星，距离较近，呈现双天体系统的感觉。', ['冥王星卫星', '双天体']),
